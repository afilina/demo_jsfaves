...
/**
 * IMPORTANT!
 * This code does two unnecessary things for the sake of the demo:
 * using chunks and sleeping the PHP for 2 seconds.
 * This way we have time to see the upload progress.
 */
